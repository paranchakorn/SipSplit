  ...
  return (
    <Card>
      <div className="p-4 sm:p-6">
        <h2 className="text-2xl font-bold mb-4 text-primary">สรุปว่าใครต้องจ่ายใคร?</h2>
        {settlements.length > 0 ? (
          <ul className="space-y-3">
            {settlements.map((settlement, index) => (
              <li key={index} className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-3 bg-background gap-2">
